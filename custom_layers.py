...
class CoordASPPSeparableConv(nn.Sequential):
    def __init__(self, in_channels, out_channels, dilation):
        super().__init__(
            CoordSeparableConv2d(
                in_channels,
                out_channels,
                kernel_size=3,
                padding=dilation,
...
class CoordASPP(nn.Module):
    def __init__(self, in_channels, out_channels, atrous_rates, separable=False):
        ...
        ASPPConvModule = CoordASPPConv if not separable else CoordASPPSeparableConv

        modules.append(ASPPConvModule(in_channels, out_channels, rate1))
        modules.append(ASPPConvModule(in_channels, out_channels, rate2))
        modules.append(ASPPConvModule(in_channels, out_channels, rate3))
        modules.append(ASPPConvModule(in_channels, out_channels, rate4))
        modules.append(CoordASPPPooling(in_channels, out_channels))
...
class CoordSeparableConv2d(nn.Sequential):
    def __init__(
        self,
        in_channels,
        out_channels,
